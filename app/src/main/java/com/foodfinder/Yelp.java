...
public class Yelp {
  ...
  public static void main(String[] args) {
    ...
    String consumerKey = "Ai4UtiLr8gqSnSj4cZJBuQ";
    String consumerSecret = "EXWxBF7INjaQv28GXBQruN5w65Q";
    String token = "n1lDJ5HLiUL8V6r6ocGQ9Ao6hxklJp30";
    String tokenSecret = "ZrkwCUZMKvyuHGSeFuwr-mUKfF0";
