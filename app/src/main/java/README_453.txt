...
- Attempted to use OpenTable and Yelp together for table reservations.


Time Spent:
-UI Design using Intents - 2 days
-Parsing Yelp API - 1 week
-Parsing OpenTable -3 days

Time spent learning New concept:
-Learning how to query with parameters using an API  - around 1 week
-Learning how to parse json request from the API - 1 week
-Yelp Documentation - 2 days
